...
} from "./chunk-UZLQ3LCX.js";
import {
  EffectWrapper
} from "./chunk-7JXVZAJL.js";
import {
  BaseTexture,
  Texture
} from "./chunk-XIOLXEAJ.js";
import {
  SerializationHelper
} from "./chunk-4MTGKVEW.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-LM7KCAKV.js").then((module) => this._dumpTools = module);
    }
...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!RegisteredTextureLoaders.has(extension)) {
    ...
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-MAVXAQS7.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", async () => await import("./basisTextureLoader-POMKYZSH.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", async () => await import("./envTextureLoader-E6ZA2T2B.js").then((module) => new module._ENVTextureLoader()));
    }
    ...
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-D5TP5CKP.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-D5TP5CKP.js").then((module) => new module._KTXTextureLoader()));
    }
    ...
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", async () => await import("./exrTextureLoader-V3AU5ZQ7.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-IFACPDFF.js");
    const textures = [];
...
//# sourceMappingURL=chunk-TU4XV2QC.js.map
