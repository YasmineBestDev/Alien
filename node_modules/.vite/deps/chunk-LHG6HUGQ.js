...
import {
  PickingInfo
} from "./chunk-7KTPVQZF.js";
import {
  UniformBuffer
} from "./chunk-MI6YUQ72.js";
import {
  Axis,
...
import {
  Tools
} from "./chunk-JFB4YVTV.js";
import {
  ErrorCodes,
  RuntimeError
} from "./chunk-KFPBW4UT.js";
import {
  AbstractEngine,
  AlphaState,
  DepthCullingState,
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name3, options = {}) {
    const module = await import("./webAudioBus-7PFOXYRI.js");
  ...
  async createMainBusAsync(name3, options = {}) {
    const module = await import("./webAudioMainBus-TUL7M4PR.js");
  ...
  async createSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStaticSound-5PJ42RTK.js");
  ...
  async createSoundSourceAsync(name3, source, options = {}) {
    const module = await import("./webAudioSoundSource-UBDCWC2D.js");
  ...
  async createStreamingSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStreamingSound-NFBNBMJJ.js");
...
//# sourceMappingURL=chunk-LHG6HUGQ.js.map
